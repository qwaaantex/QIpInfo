...
ThemeData themeLight() {
  return ThemeData(
    ...
    textSelectionTheme: TextSelectionThemeData(cursorColor: Colors.black, selectionColor: Colors.black, selectionHandleColor: Colors.black),
            textTheme: TextTheme(titleMedium: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.bold), bodySmall: TextStyle(color: Colors.grey), labelMedium: TextStyle(color: Colors.grey), headlineSmall: TextStyle(color: Colors.white, fontSize: 16), titleLarge: TextStyle(color: Colors.red.shade300, fontSize: 22, fontWeight: FontWeight.bold), titleSmall: TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.bold), bodyLarge: TextStyle(color: Colors.black, fontSize: 15), displaySmall: TextStyle(color: Colors.black, fontSize: 14))
